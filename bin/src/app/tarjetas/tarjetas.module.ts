...
import { MisTarjetasFilterComponent } from './mis-tarjetas/mis-tarjetas-filter/mis-tarjetas-filter.component';
...
@NgModule({
  ...
  declarations: [MisTarjetasComponent, MisTarjetasListComponent, MisTarjetasListDateComponent, MisTarjetasFilterComponent, MisTarjetasListItemComponent]
})
